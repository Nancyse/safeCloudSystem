...
<link href="<%=basePath%>/css/typo.css" rel='stylesheet' type='text/css' />
<!-- font CSS -->
...
<!--文件上传插件-->
	<link rel="stylesheet" href="<%=basePath%>/control/css/zyUpload.css" type="text/css">
	<script type="text/javascript" src="<%=basePath%>/control/js/jquery-1.7.2.js"></script>
	<!-- 引用核心层插件 -->
	<script type="text/javascript" src="<%=basePath%>/core/zyFile.js"></script>
	<!-- 引用控制层插件 -->
	<script type="text/javascript" src="<%=basePath%>/control/js/zyUpload.js"></script>
	<!-- 引用初始化JS -->
	<script type="text/javascript" src="<%=basePath%>/control/js/demo.js"></script>
<!--文件上传插件-->
